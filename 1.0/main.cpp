#include "ext.h"
//#include "funcs.cpp" // please include this line if you don't have codeblocks
#include <bits/stdc++.h>
...
int main(){
    ...
    double i_orientations[nop][3]; //initial orientations
    ...
    ofstream initdir;
    initdir.open("init_cosines.csv");
    for (int j =0;j<nop;j++){
        initdir<<i_orientations[j][0]<<","<<i_orientations[j][1]<<","<<i_orientations[j][2]<<endl;
    }
    initdir.close();

    ofstream outnew;
	outnew.open ("DLA.csv");
	outnew << "0,1,2,11,22,33,4"<<endl;
        ...
        //#random walk
            ...
            if (overlap==true){
                ...
                while (1){
                    ...
                    /*moving a fractional angle*/
                        ...
                        if (o==false){ // stuck
                            /*if (br>2.0*R){ //for debugging purposes
                                cout << "some error" << br<<endl;
                                break;
                            }*/
                            stuck=true; //stuck
                            col = ii;
            ...
            if (stuck==true){
                ...
                for (int j=0;j<ar;j++){
                    ...
                    outnew << v[0]<<","<<v[1]<<","<<v[2]<<","<<fin_axis[0]<<","<<fin_axis[1]<<","<<fin_axis[2]<<","<<col<<endl;
                }
